...
const STANDARD_VALUES = [320, 375, 480, 576, 640, 768, 800, 900, 960, 1024, 1200, 1280, 1440, 1536, 1920];
function isStandard(value) {
    return STANDARD_VALUES.some(s => Math.abs(s - value) <= 4);
}
export function checkBreakpoints(data) {
    const violations = [];
    ...
    if (strategy === 'mixed') {
        violations.push({
            ...
            severity: 'warn',
            message: 'Mixed strategy: both min-width and max-width media queries detected',
